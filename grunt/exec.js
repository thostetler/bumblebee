...
module.exports = {
  ...
  convert_redux_immutable: {
    cmd: 'mkdir src/libs/redux-immutable node_modules/.bin/browserify --standalone combineReducers node_modules/redux-immutable/dist/index.js > libs/redux-immutable/index.js'
  },
  latest_commit: {
