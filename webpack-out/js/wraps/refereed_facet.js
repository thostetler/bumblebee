define(['js/widgets/facet/factory', 'analytics'], function (FacetFactory, analytics) {
  return function () {
    var widget = FacetFactory.makeBasicCheckboxFacet({
      ...
      preprocessors: function preprocessors(facetList) {
    ...
    widget.handleLogicalSelection = function (operator) {
      ...
      var conditions = this.queryUpdater.removeTmpEntry(q, 'SelectedItems'); // XXX:rca - hack ; this logic is triggerd multiple times
