define(['underscore', 'jquery', 'js/components/alerts_mediator', 'js/components/api_feedback', 'js/widgets/widget_states', 'js/components/alerts', 'js/components/api_response'], function (_, $, AlertsMediator, ApiFeedback, WidgetStates, Alerts, ApiResponse) {
