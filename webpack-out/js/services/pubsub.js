 ...
 */
define(['backbone', 'underscore', 'js/mixins/hardened', 'pubsub_service_impl', 'js/components/pubsub_events'], function (Backbone, _, Hardened, PubSubImplementation, PubSubEvents) {
