define(['underscore', 'backbone', 'react', 'react-redux', 'react-dom', 'js/widgets/orcid-selector/redux/configure-store', 'js/widgets/orcid-selector/redux/modules/orcid-selector-app', 'js/widgets/base/base_widget', 'js/widgets/orcid-selector/containers/orcid-selector-container'], function (_, Backbone, React, ReactRedux, ReactDOM, configureStore, OrcidSelectorApp, BaseWidget, OrcidSelectorContainer) {
  /**
   * Main App View
   *
