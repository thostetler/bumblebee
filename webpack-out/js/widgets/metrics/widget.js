define(['underscore', 'marionette', 'd3', 'js/widgets/base/base_widget', 'js/widgets/metrics/extractor_functions', 'js/components/api_response', 'js/components/json_response', 'js/components/api_request', 'js/components/api_query', 'js/mixins/dependon', 'js/widgets/metrics/templates/metrics_container.html', 'js/widgets/metrics/templates/graph_template.html', 'js/widgets/metrics/templates/paper_table.html', 'js/widgets/metrics/templates/citations_table.html', 'js/widgets/metrics/templates/indices_table.html', 'js/widgets/metrics/templates/reads_table.html', 'bootstrap', 'js/components/api_feedback', 'js/components/api_targets', 'js/widgets/metrics/d3-tip'], function (_, Marionette, d3, BaseWidget, DataExtractor, ApiResponse, JsonResponse, ApiRequest, ApiQuery, Dependon, MetricsContainer, GraphTemplate, PaperTableTemplate, CitationsTableTemplate, IndicesTableTemplate, ReadsTableTemplate, bs, ApiFeedback, ApiTargets, _d3Tip) {
  /*
