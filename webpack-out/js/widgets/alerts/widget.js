...
'js/components/alerts', 'js/widgets/alerts/modal_view', 'js/widgets/alerts/page_top_alert', 'jquery', 'jquery-ui', 'bootstrap'], function (Marionette, BaseWidget, ApiQuery, Alerts, ApiFeedback, ModalView, BannerView, $, $ui, bootstrap) {
