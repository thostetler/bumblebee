define(['backbone', 'js/components/api_query', 'js/components/api_request', 'js/widgets/base/base_widget', 'js/components/api_query_updater', 'analytics', 'react', 'react-dom', 'react-redux', 'js/widgets/facet/facet-container.jsx', 'js/widgets/facet/actions', 'js/widgets/facet/reducers', 'js/widgets/facet/create_store', 'utils'], function (Backbone, ApiQuery, ApiRequest, BaseWidget, ApiQueryUpdater, analytics, React, ReactDOM, ReactRedux, ContainerComponent, createActionObject, Reducers, createStore, utils) {
