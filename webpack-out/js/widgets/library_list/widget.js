define(['marionette', 'js/widgets/list_of_things/item_view', 'js/widgets/list_of_things/widget', 'js/widgets/list_of_things/paginated_view', 'js/widgets/list_of_things/model', 'js/widgets/library_list/templates/library-container.html', 'js/widgets/library_list/templates/library-item-edit.html', 'js/widgets/library_list/templates/empty-collection.html', 'js/mixins/link_generator_mixin', 'js/mixins/papers_utils', 'js/mixins/formatter', 'js/components/api_query', 'js/components/api_request', 'js/components/api_response', 'js/components/api_targets', 'js/mixins/add_stable_index_to_collection', 'js/mixins/add_secondary_sort', 'bootstrap', 'js/wraps/widget/loading/template.html', 'js/widgets/sort/widget.jsx', 'js/widgets/sort/redux/modules/sort-app'], function (Marionette, DefaultItemView, ListOfThingsWidget, ListOfThingsPaginatedContainerView, PaginatedCollection, LibraryContainer, LibraryItemEditTemplate, EmptyCollectionTemplate, LinkGeneratorMixin, PapersUtilsMixin, FormatMixin, ApiQuery, ApiRequest, ApiResponse, ApiTargets, PaginationMixin, SecondarySort, Bootstrap, loadingTemplate, SortWidget, SortActions) {
