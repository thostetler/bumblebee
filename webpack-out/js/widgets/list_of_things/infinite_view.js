...
define(['marionette', 'backbone', 'js/widgets/list_of_things/templates/expanding-item-template.html', 'js/widgets/list_of_things/templates/expanding-results-container-template.html'], function (Marionette, Backbone, ItemTemplate, ResultsContainerTemplate) {
  ...
  var ListView = Marionette.CompositeView.extend({
    ...
    fetchMore: function fetchMore(ev) {
     ...
     * @param howMany
     */
    displayMore: function displayMore(howMany) {
     ...
     * @param text
     */
    disableShowMore: function disableShowMore(text) {
     ...
     * @param text
     */
    enableShowMore: function enableShowMore(text) {
     ...
     * @param text
     */
    toggleDetailsControls: function toggleDetailsControls(visible) {
      if (visible) {
