 ...
 *
 */
define(['underscore', 'marionette', 'backbone', 'js/components/api_request', 'js/components/api_query', 'js/widgets/base/base_widget', 'hbs!js/widgets/list_of_things/templates/item-template', 'hbs!js/widgets/list_of_things/templates/results-container-template', 'js/mixins/link_generator_mixin', 'js/mixins/add_stable_index_to_collection', 'hbs!js/widgets/list_of_things/templates/empty-view-template', 'hbs!js/widgets/list_of_things/templates/error-view-template', 'hbs!js/widgets/list_of_things/templates/initial-view-template', 'js/widgets/list_of_things/item_view', 'analytics', 'mathjax', 'hbs!js/wraps/widget/loading/template'], function (_, Marionette, Backbone, ApiRequest, ApiQuery, BaseWidget, ItemTemplate, ResultsContainerTemplate, LinkGenerator, WidgetPaginationMixin, EmptyViewTemplate, ErrorViewTemplate, InitialViewTemplate, ItemView, analytics, MathJax, loadingTemplate) {
  /**
