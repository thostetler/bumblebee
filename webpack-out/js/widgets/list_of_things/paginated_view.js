 ...
 *
 */
define(['underscore', 'marionette', 'backbone', 'js/components/api_request', 'js/components/api_query', 'js/widgets/base/base_widget', 'js/widgets/list_of_things/templates/item-template.html', 'js/widgets/list_of_things/templates/results-container-template.html', 'js/mixins/link_generator_mixin', 'js/mixins/add_stable_index_to_collection', 'js/widgets/list_of_things/templates/empty-view-template.html', 'js/widgets/list_of_things/templates/error-view-template.html', 'js/widgets/list_of_things/templates/initial-view-template.html', 'js/widgets/list_of_things/item_view', 'analytics', 'mathjax', 'js/wraps/widget/loading/template.html'], function (_, Marionette, Backbone, ApiRequest, ApiQuery, BaseWidget, ItemTemplate, ResultsContainerTemplate, LinkGenerator, WidgetPaginationMixin, EmptyViewTemplate, ErrorViewTemplate, InitialViewTemplate, ItemView, analytics, MathJax, loadingTemplate) {
  /**
