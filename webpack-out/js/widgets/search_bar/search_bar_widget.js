...
define(['underscore', 'marionette', 'bowser', 'js/components/api_query', 'js/widgets/base/base_widget', 'js/widgets/search_bar/templates/search_bar_template.html', 'js/widgets/search_bar/templates/search_form_template.html', 'js/widgets/search_bar/templates/option-dropdown.html', 'js/components/api_request', 'js/components/api_targets', 'js/components/api_feedback', 'js/mixins/formatter', 'js/widgets/search_bar/autocomplete', 'js/widgets/search_bar/quick-field-desc', 'bootstrap', // if bootstrap is missing, jQuery events get propagated
'jquery-ui', 'js/mixins/dependon', 'analytics', 'js/components/query_validator', 'select2', 'libs/select2/matcher'], function (_, Marionette, bowser, ApiQuery, BaseWidget, SearchBarTemplate, SearchFormTemplate, OptionDropdownTemplate, ApiRequest, ApiTargets, ApiFeedback, FormatMixin, _ref, quickFieldDesc, bootstrap, jqueryUI, Dependon, analytics, QueryValidator, select2, oldMatcher) {
  var _events;
