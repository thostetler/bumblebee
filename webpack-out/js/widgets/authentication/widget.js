define(['marionette', 'js/widgets/base/base_widget', 'js/components/api_feedback', 'js/mixins/form_view_functions', 'js/widgets/success/view', 'js/components/api_targets', 'hbs!js/widgets/authentication/templates/log-in', 'hbs!js/widgets/authentication/templates/register', 'hbs!js/widgets/authentication/templates/container', 'hbs!js/widgets/authentication/templates/reset-password-1', 'hbs!js/widgets/authentication/templates/reset-password-2', 'hbs!js/widgets/authentication/templates/resend-verification-email', 'js/components/user', 'analytics', 'backbone-validation', 'backbone.stickit'], function (Marionette, BaseWidget, ApiFeedback, FormFunctions, SuccessView, ApiTargets, LogInTemplate, RegisterTemplate, ContainerTemplate, ResetPassword1Template, ResetPassword2Template, ResendVerificationEmail, User, analytics) {
