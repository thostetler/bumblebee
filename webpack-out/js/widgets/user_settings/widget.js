define(['marionette', 'js/widgets/base/base_widget', 'js/mixins/form_view_functions', 'js/widgets/success/view', 'js/components/api_feedback', 'hbs!js/widgets/user_settings/templates/api_key', 'hbs!js/widgets/user_settings/templates/change_email', 'hbs!js/widgets/user_settings/templates/change_password', 'hbs!js/widgets/user_settings/templates/delete_account', 'backbone-validation', 'backbone.stickit', 'bootstrap'], function (Marionette, BaseWidget, FormFunctions, SuccessView, ApiFeedback, TokenTemplate, EmailTemplate, PasswordTemplate, DeleteAccountTemplate, Bootstrap) {
