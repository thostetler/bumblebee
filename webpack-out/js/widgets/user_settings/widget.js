define(['marionette', 'js/widgets/base/base_widget', 'js/mixins/form_view_functions', 'js/widgets/success/view', 'js/components/api_feedback', 'js/widgets/user_settings/templates/api_key.html', 'js/widgets/user_settings/templates/change_email.html', 'js/widgets/user_settings/templates/change_password.html', 'js/widgets/user_settings/templates/delete_account.html', 'backbone-validation', 'backbone.stickit', 'bootstrap'], function (Marionette, BaseWidget, FormFunctions, SuccessView, ApiFeedback, TokenTemplate, EmailTemplate, PasswordTemplate, DeleteAccountTemplate, Bootstrap) {
  ...
  UserSettingsView = Marionette.LayoutView.extend({
    ...
    showPasswordSuccessView: function showPasswordSuccessView() {
      this.content.show(new SuccessView({
