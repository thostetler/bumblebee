 ...
 */
define(['underscore', 'js/components/api_query', 'js/components/api_request', 'js/components/api_query_updater', 'js/components/api_targets', 'js/modules/orcid/work', 'js/components/api_feedback', 'js/mixins/dependon'], function (_, ApiQuery, ApiRequest, ApiQueryUpdater, ApiTargets, Work, ApiFeedback) {
