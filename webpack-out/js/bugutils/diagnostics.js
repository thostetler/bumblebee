 ...
 */
define(['jquery', 'underscore', 'js/components/api_query', 'js/components/api_request', 'js/components/api_response', 'js/mixins/dependon', 'js/components/generic_module', 'sprintf', 'js/components/api_targets'], function ($, _, ApiQuery, ApiRequest, ApiResponse, Dependon, GenericModule, sprintf, ApiTargets) {
