define(['backbone', 'js/components/generic_module', 'js/mixins/hardened', 'js/components/api_targets', 'js/components/api_request', 'js/components/api_feedback', 'js/components/api_query', 'js/mixins/dependon', 'utils'], function (Backbone, GenericModule, Hardened, ApiTargets, ApiRequest, ApiFeedback, ApiQuery, Dependon, utils) {
