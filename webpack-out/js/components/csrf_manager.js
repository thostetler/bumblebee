 ...
 *
 * */
define(['backbone', 'js/components/generic_module', 'js/mixins/hardened', 'js/components/api_request', 'js/components/api_targets', 'js/mixins/dependon'], function (Backbone, GenericModule, Hardened, ApiRequest, ApiTargets, Dependon) {
