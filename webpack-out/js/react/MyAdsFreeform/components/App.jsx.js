...
define(['react', 'prop-types', 'react-bootstrap', 'js/react/MyAdsFreeform/components/CollapsePanel.jsx', 'js/react/MyAdsFreeform/containers/SaveQueryForm'], function (React, PropTypes, _ref, CollapsePanel, SaveQueryForm) {
  ...
  var MyADSFreeform = /*#__PURE__*/function (_React$Component) {
    ...
    function MyADSFreeform(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(MyADSFreeform).call(this, props));
