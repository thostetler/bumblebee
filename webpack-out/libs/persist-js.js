...
Persist = function () {
  ...
  ec = function () {
    ...
    var get_now = function get_now() {
      var r = new Date();
      r.setTime(r.getTime());
      return r;
    };

    var cookify = function cookify(c_key, c_val) {
      var i,
          key,
          val,
          r = [],
  ...
  B = {
    gears: {
      ...
      methods: {
        ...
        iterate: function iterate(fn, scope) {
    ...
    ie: {
      ...
      make_userdata: function make_userdata(id) {
    ...
    cookie: {
      ...
      methods: {
        key: function key(_key3) {
          return this.name + B.cookie.delim + _key3;
        },
