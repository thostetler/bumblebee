  ...
  return function a(b, c, d) {
      ...
      !function (b, c) {
        ...
        function o(a) {
          ...
          for (b = ib - a, c = {
            ...
            if (d = gb.charCodeAt(ib), ++ib, g(d)) return pb.comments && (e = gb.slice(b + a, ib - 1), c.end = {
              line: jb,
              column: ib - kb - 1
        ...
        function p() {
          ...
          for (pb.comments && (a = ib - 2, b = {
            ...
            if (c = gb.charCodeAt(ib), g(c)) 13 === c && 10 === gb.charCodeAt(ib + 1) && ++ib, ++jb, ++ib, kb = ib, ib >= lb && O({}, db.UnexpectedToken, "ILLEGAL");else if (42 === c) {
        ...
        function q() {
          ...
          for (b = 0 === ib; ib < lb;) {
            if (a = gb.charCodeAt(ib), f(a)) ++ib;else if (g(a)) ++ib, 13 === a && 10 === gb.charCodeAt(ib) && ++ib, ++jb, kb = ib, b = !0;else if (47 === a) {
              if (a = gb.charCodeAt(ib + 1), 47 === a) ++ib, ++ib, o(2), b = !0;else {
                if (42 !== a) break;
                ++ib, ++ib, p();
              }
            } else if (b && 45 === a) {
        ...
        function s() {
          ...
          for (a = gb.charCodeAt(ib++), b = String.fromCharCode(a), 92 === a && (117 !== gb.charCodeAt(ib) && O({}, db.UnexpectedToken, "ILLEGAL"), ++ib, a = r("u"), a && "\\" !== a && h(a.charCodeAt(0)) || O({}, db.UnexpectedToken, "ILLEGAL"), b = a); ib < lb && (a = gb.charCodeAt(ib), i(a));) {
            ++ib, b += String.fromCharCode(a), 92 === a && (b = b.substr(0, b.length - 1), 117 !== gb.charCodeAt(ib) && O({}, db.UnexpectedToken, "ILLEGAL"), ++ib, a = r("u"), a && "\\" !== a && i(a.charCodeAt(0)) || O({}, db.UnexpectedToken, "ILLEGAL"), b += a);
          }
        ...
        function y() {
          ...
          if ("." === f) {
            for (a += gb[ib++]; c(gb.charCodeAt(ib));) {
              a += gb[ib++];
            }
          ...
          if ("e" === f || "E" === f) if (a += gb[ib++], f = gb[ib], "+" !== f && "-" !== f || (a += gb[ib++]), c(gb.charCodeAt(ib))) for (; c(gb.charCodeAt(ib));) {
            a += gb[ib++];
        ...
        function z() {
          ...
          for (j = jb, k = kb, a = gb[ib], b("'" === a || '"' === a, "String literal must starts with a quote"), c = ib, ++ib; ib < lb;) {
            ...
            if ("\\" === d) {
              if (d = gb[ib++], d && g(d.charCodeAt(0))) ++jb, "\r" === d && "\n" === gb[ib] && ++ib, kb = ib;else switch (d) {
                case "u":
                case "x":
        ...
        function B() {
          ...
          for (a = gb[ib], b("/" === a, "Regular expression literal must start with a slash"), c = gb[ib++], d = !1, e = !1; ib < lb;) {
            if (a = gb[ib++], c += a, "\\" === a) a = gb[ib++], g(a.charCodeAt(0)) && O({}, db.UnterminatedRegExp), c += a;else if (g(a.charCodeAt(0))) O({}, db.UnterminatedRegExp);else if (d) "]" === a && (d = !1);else {
              if ("/" === a) {
                e = !0;
                break;
              }
        ...
        function C() {
          ...
          for (b = "", c = ""; ib < lb && (a = gb[ib], i(a.charCodeAt(0)));) {
            if (++ib, "\\" === a && ib < lb) {
              if (a = gb[ib], "u" === a) {
                if (++ib, d = ib, a = r("u")) for (c += a, b += "\\u"; d < ib; ++d) {
                  b += gb[d];
                } else ib = d, c += "u", b += "\\u";
        ...
        function V() {
          var a;
          return nb.type === $a.Punctuator && (a = nb.value, "=" === a || "*=" === a || "/=" === a || "%=" === a || "+=" === a || "-=" === a || "<<=" === a || ">>=" === a || ">>>=" === a || "&=" === a || "^=" === a || "|=" === a);
        }
        ...
        function ja() {
          ...
          for (d = nb, a = ob.allowIn, b = U("new") ? ha() : ca(), ob.allowIn = a; T(".") || T("[");) {
            T("[") ? (c = ga(), b = mb.createMemberExpression("[", b, c)) : (c = fa(), b = mb.createMemberExpression(".", b, c)), mb.markEnd(b, d);
          }
        ...
        function na() {
          ...
          for (d.prec = e, J(), b = [a, nb], g = la(), f = [i, d, g]; (e = ma(nb, ob.allowIn)) > 0;) {
            for (; f.length > 2 && e <= f[f.length - 2].prec;) {
              g = f.pop(), h = f.pop().value, i = f.pop(), c = mb.createBinaryExpression(h, i, g), b.pop(), a = b[b.length - 1], mb.markEnd(c, a), f.push(c);
            }
          ...
          for (j = f.length - 1, c = f[j], b.pop(); j > 1;) {
            c = mb.createBinaryExpression(f[j - 1].value, f[j - 2], c), j -= 2, a = b.pop(), mb.markEnd(c, a);
          }
        ...
        function ra() {
          for (var a, b = []; ib < lb && !T("}") && (a = Ua(), "undefined" != typeof a);) {
            b.push(a);
          }
        ...
        function Ja() {
          ...
          for (c = nb, U("default") ? (J(), a = null) : (S("case"), a = qa()), R(":"); ib < lb && !(T("}") || U("default") || U("case"));) {
            b = Pa(), d.push(b);
          }
        ...
        function Ka() {
          ...
          for (d = ob.inSwitch, ob.inSwitch = !0, e = !1; ib < lb && !T("}");) {
            c = Ja(), null === c.test && (e && O({}, db.MultipleDefaultsInSwitch), e = !0), b.push(c);
          }
        ...
        function Qa() {
          ...
          for (i = nb, R("{"); ib < lb && nb.type === $a.StringLiteral && (b = nb, a = Ua(), j.push(a), a.expression.type === bb.Literal);) {
            c = gb.slice(b.start + 1, b.end - 1), "use strict" === c ? (hb = !0, d && P(d, db.StrictOctalLiteral)) : !d && b.octal && (d = b);
          }

          for (e = ob.labelSet, f = ob.inIteration, g = ob.inSwitch, h = ob.inFunctionBody, ob.labelSet = {}, ob.inIteration = !1, ob.inSwitch = !1, ob.inFunctionBody = !0; ib < lb && !T("}") && (a = Ua(), "undefined" != typeof a);) {
            j.push(a);
          }
        ...
        function Ra(a) {
          var b,
              ...
              g,
              h = [];
          if (R("("), !T(")")) for (e = {}; ib < lb && (c = nb, b = ta(), f = "$" + c.value, hb ? (l(c.value) && (d = c, g = db.StrictParamName), Object.prototype.hasOwnProperty.call(e, f) && (d = c, g = db.StrictParamDupe)) : a || (l(c.value) ? (a = c, g = db.StrictParamName) : k(c.value) ? (a = c, g = db.StrictReservedWord) : Object.prototype.hasOwnProperty.call(e, f) && (a = c, g = db.StrictParamDupe)), h.push(b), e[f] = !0, !T(")"));) {
            R(",");
          }
          return R(")"), {
            params: h,
        ...
        function Va() {
          for (var a, b, c, d, e = []; ib < lb && (b = nb, b.type === $a.StringLiteral) && (a = Ua(), e.push(a), a.expression.type === bb.Literal);) {
            c = gb.slice(b.start + 1, b.end - 1), "use strict" === c ? (hb = !0, d && P(d, db.StrictOctalLiteral)) : !d && b.octal && (d = b);
          }

          for (; ib < lb && (a = Ua(), "undefined" != typeof a);) {
            e.push(a);
          }
        ...
        $a = {
          ...
          name: "SyntaxTree",
          processComment: function processComment(a) {
            var b, c;
      ...
      (function (d) {
        var e = function () {
          ...
          var b = {
            ...
            performAction: function performAction(a, b, d, e, f, g, h) {
            ...
            var a = {
              ...
              test_match: function test_match(a, b) {
                var c, d, e;
              ...
              options: {},
              performAction: function performAction(a, b, c, d) {
                switch (c) {
                  case 0:
                    return 4;
    ...
    4: [function (a, b, c) {
      ...
      q.prototype.initialize = function () {
        ...
        "member-child-identifier": function memberChildIdentifier(a, b) {
        ...
        "subscript-child-slice": function subscriptChildSlice(a, b) {
          if (e(b.value)) {
        ...
        "subscript-child-union": function subscriptChildUnion(a, b) {
          var c = [];
        ...
        "subscript-descendant-union": function subscriptDescendantUnion(b, c, d) {
          var e = a(".."),
              f = this,
              g = [],
              h = e.nodes(c, "$..*").slice(1);
        ...
        "subscript-child-filter_expression": function subscriptChildFilter_expression(a, b, c) {
        ...
        "subscript-descendant-filter_expression": function subscriptDescendantFilter_expression(a, b, c) {
          var d = a.expression.value.slice(2, -1),
              e = m.parse(d).body[0].expression,
              f = function f(a, b) {
            return j(e, {
        ...
        "subscript-child-script_expression": function subscriptChildScript_expression(a, b) {
          var c = a.expression.value.slice(1, -1);
          return d(b, c, "$[{{value}}]");
        },
        "member-child-script_expression": function memberChildScript_expression(a, b) {
          var c = a.expression.value.slice(1, -1);
          return d(b, c, "$.{{value}}");
        },
        "member-descendant-script_expression": function memberDescendantScript_expression(a, b) {
          var c = a.expression.value.slice(1, -1);
          return d(b, c, "$..value");
        }
    ...
    5: [function (a, b, c) {
      ...
      i.prototype.initialize = function () {
        ...
        e.ok(a instanceof Object, "obj needs to be an object"), e.ok(b, "we need a path"), e.equal(_typeof(c), "function", "fn needs to be function");
        ...
        if (e.ok(a instanceof Object, "obj needs to be an object"), e.ok(b, "we need a path"), arguments.length >= 3) {
          ...
          var f = d.path.slice(-1).shift(),
              g = this.parent(a, this.stringify(d.path));
          g[f] = c;
        }
        ...
        if (Array.isArray(a) && "object" == _typeof(a[0])) return a;
    ...
    7: [function (a, b, c) {
      ...
      b.exports = function (a, b, c, e) {
        ...
        if (e = e ? d(e) : 1, b = b < 0 ? f + b : b, c = c < 0 ? f + c : c, b = d(0 === b ? 0 : b ? b : e > 0 ? 0 : f - 1), c = d(0 === c ? 0 : c ? c : e > 0 ? f : -1), b = e > 0 ? Math.max(0, b) : Math.min(f, b), c = e > 0 ? Math.min(c, f) : Math.max(-1, c), e > 0 && c <= b) return [];
        if (e < 0 && b <= c) return [];
    ...
    11: [function (a, b, c) {
      ...
      n.nextTick = function (a) {
        ...
        if (arguments.length > 1) for (var c = 1; c < arguments.length; c++) {
          b[c - 1] = arguments[c];
        }
      ...
      b.exports = function (a, b) {
        ...
        var c = {},
          ...
          if ("UnaryExpression" === e.type) {
            var f = a(e.argument);
            return "+" === e.operator ? +f : "-" === e.operator ? -f : "~" === e.operator ? ~f : "!" === e.operator ? !f : c;
          }

          if ("ArrayExpression" === e.type) {
            for (var g = [], h = 0, i = e.elements.length; h < i; h++) {
              var j = a(e.elements[h]);
              if (j === c) return c;
              g.push(j);
            }
          ...
          if ("ObjectExpression" === e.type) {
            for (var k = {}, h = 0; h < e.properties.length; h++) {
              var l = e.properties[h],
                  m = null === l.value ? l.value : a(l.value);
              if (m === c) return c;
          ...
          if ("BinaryExpression" === e.type || "LogicalExpression" === e.type) {
            ...
            if (n === c) return c;
            var o = e.operator;
            return "==" === o ? i == n : "===" === o ? i === n : "!=" === o ? i != n : "!==" === o ? i !== n : "+" === o ? i + n : "-" === o ? i - n : "*" === o ? i * n : "/" === o ? i / n : "%" === o ? i % n : "<" === o ? i < n : "<=" === o ? i <= n : ">" === o ? i > n : ">=" === o ? i >= n : "|" === o ? i | n : "&" === o ? i & n : "^" === o ? i ^ n : "&&" === o ? i && n : "||" === o ? i || n : c;
          }
          ...
          if ("CallExpression" === e.type) {
            var p = a(e.callee);
            if (p === c) return c;
            var q = e.callee.object ? a(e.callee.object) : c;
            q === c && (q = null);

            for (var r = [], h = 0, i = e.arguments.length; h < i; h++) {
              var j = a(e.arguments[h]);
              if (j === c) return c;
              r.push(j);
            }
          ...
          if ("MemberExpression" === e.type) {
            var k = a(e.object);
            if (k === c) return c;
            if ("Identifier" === e.property.type) return k[e.property.name];
            var l = a(e.property);
            return l === c ? c : k[l];
          }
          ...
          if ("ConditionalExpression" === e.type) {
            var f = a(e.test);
            return f === c ? c : a(f ? e.consequent : e.alternate);
          }

          return "FunctionExpression" === e.type ? Function("return " + d(e))() : c;
        }(a);
    ...
    14: [function (a, b, c) {
      b.exports = function (a) {
        return a && "object" == _typeof(a) && "function" == typeof a.copy && "function" == typeof a.fill && "function" == typeof a.readUInt8;
      };
    }, {}],
    15: [function (a, b, c) {
      (function (b, d) {
        ...
        function x(a) {
          return "object" == _typeof(a) && null !== a;
        }
        ...
        function B(a) {
          return null === a || "boolean" == typeof a || "number" == typeof a || "string" == typeof a || "symbol" == _typeof(a) || "undefined" == typeof a;
        }
