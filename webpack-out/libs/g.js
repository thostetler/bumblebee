...
(function () {
  ...
  */
  ...
  var ba = Array.isArray,
      ca = function ca(a, b) {
    if (a && ba(a)) for (var c = 0; c < a.length; c++) {
  ...
  var U = function U() {
    ...
    for (var d = T().decorators, e = {}, f = 0; f < d.length; ++f) {
      ...
      if (g = !c || h.forms) a: {
        ...
        var k = a,
            m = !!h.sameHost;
        if (g && (m || k !== I.location.hostname)) for (var l = 0; l < g.length; l++) {
...
(function () {
  ...
  var ea = function ea(a) {
    ...
    if (!ff) {
      ff = {
        createScriptURL: function createScriptURL(ca) {
          return ca;
        },
        createHTML: function createHTML(ca) {
          return ca;
        }
      };
  ...
  function Sa(a) {
    ...
    a.set(Ia, ua, !0);
    if (rf(a)) if (ca = P(a, Na), l = sf[ca]) for (ca = 0; ca < l.length; ++ca) {
  ...
  function mf(a, b) {
    if (a) if ("object" === _typeof(a)) for (var c in a) {
  ...
  function pd(a) {
    ...
    c = a.set;
    var l;
    if ((e = (e = O.navigator) ? e.plugins : null) && e.length) for (g = 0; g < e.length && !l; g++) {
