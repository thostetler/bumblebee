...
(function () {
  ...
  function u(n) {
    var r = -1,
        ...
        u = n[t / 2 | 0],
        a = n[t - 1];
    if (o && "object" == _typeof(o) && u && "object" == _typeof(u) && a && "object" == _typeof(a)) return !1;
    var i = l();
    i["false"] = i["null"] = i["true"] = i.undefined = !1;
    var c = l();

    for (c.array = n, c.cache = i, c.push = e; ++r < t;) {
      c.push(n[r]);
    }
  ...
  function p(n, r, e) {
    ...
    for (var t = -1, o = e - r || 0, u = Array(o < 0 ? 0 : o); ++t < o;) {
      u[t] = n[r + t];
    }
  ...
  function g(e) {
    function v(n) {
      return n && "object" == _typeof(n) && !st(n) && Ke.call(n, "__wrapped__") ? n : new y(n);
    }
    ...
    function Z(n, r, e, t, o) {
      ...
      return g && (Ke.call(n, "index") && (u.index = n.index), Ke.call(n, "input") && (u.input = n.input)), r ? (t.push(n), o.push(u), (g ? wt : Ct)(n, function (n, a) {
        u[a] = Z(n, r, e, t, o);
      }), h && (f(t), f(o)), u) : u;
    }
    ...
    function an(n, r, e, t) {
      for (var o = (t || 0) - 1, u = n ? n.length : 0, a = []; ++o < u;) {
        ...
        if (i && "object" == _typeof(i) && "number" == typeof i.length && (st(i) || _n(i))) {
          r || (i = an(i, r, e));
          var l = -1,
              c = i.length,
              f = a.length;
    ...
    function ln(n, r, e, t, o, u) {
      ...
      if (!v) {
        ...
        var d = !lt.argsObject && _n(n) ? Oe : n.constructor,
            m = !lt.argsObject && _n(r) ? Oe : r.constructor;
      ...
      if (a = !0, o.push(n), u.push(r), v) {
        if (w = n.length, x = r.length, a = x == w, a || t) for (; x--;) {
          var j = w,
              k = r[x];
          if (t) for (; j-- && !(a = ln(n[j], k, e, t, o, u));) {
            ;
          } else if (!(a = ln(n[x], k, e, t, o, u))) break;
        }
    ...
    function _n(n) {
      return n && "object" == _typeof(n) && "number" == typeof n.length && $e.call(n) == F || !1;
    }
    ...
    function In(n) {
      return n === !0 || n === !1 || n && "object" == _typeof(n) && $e.call(n) == H || !1;
    }

    function Ln(n) {
      return n && "object" == _typeof(n) && $e.call(n) == W || !1;
    }
    ...
    function Wn(n) {
      return "number" == typeof n || n && "object" == _typeof(n) && $e.call(n) == K || !1;
    }

    function qn(n) {
      return n && Y[_typeof(n)] && $e.call(n) == M || !1;
    }

    function zn(n) {
      return "string" == typeof n || n && "object" == _typeof(n) && $e.call(n) == V || !1;
    }
    ...
    function Mn(n) {
      ...
      for (var o = p(arguments, 1, e), u = -1, a = i(), l = i(); ++u < e;) {
        cn(n, o[u], t, a, l);
      }
    ...
    function Yn(n) {
      ...
      for (lt.unindexedChars && zn(n) && (n = n.split("")); ++e < o;) {
        u[e] = n[t[e]];
      }
    ...
    function nr(n, r, e) {
      var t = !0;
      if (r = v.createCallback(r, e, 3), st(n)) for (var o = -1, u = n.length; ++o < u && (t = !!r(n[o], o, n));) {
        ;
    ...
    function or(n, r, e) {
      if (r && "undefined" == typeof e && st(n)) for (var t = -1, o = n.length; ++t < o && r(n[t], t, n) !== !1;) {
        ;
      } else wt(n, r, e);
      return n;
    }
    ...
    function ur(n, r, e) {
      var t = n,
          o = n ? n.length : 0;
      if (r = r && "undefined" == typeof e ? r : en(r, e, 3), st(n)) for (; o-- && r(n[o], o, n) !== !1;) {
        ;
      } else {
        if ("number" != typeof o) {
          var u = gt(n);
    ...
    function jr(n, r, e) {
      ...
      if ("number" != typeof r && null != r) {
        ...
        for (r = v.createCallback(r, e, 3); ++u < o && r(n[u], u, n);) {
          t++;
        }
    ...
    function Pr(n, r, e) {
      ...
      if ("number" != typeof r && null != r) {
        ...
        for (r = v.createCallback(r, e, 3); u-- && r(n[u], u, n);) {
          t++;
        }
    ...
    function Ir(n, r, e) {
      ...
      for (var t = -1, o = et(0, Be((r - n) / (e || 1))), u = we(o); ++t < o;) {
        u[t] = n, n += e;
      }
    ...
    function Nr(n, r, e) {
      if ("number" != typeof r && null != r) {
        ...
        for (r = v.createCallback(r, e, 3); ++o < u && r(n[o], o, n);) {
          t++;
        }
    ...
    lt.argsClass || (_n = function _n(n) {
      return n && "object" == _typeof(n) && "number" == typeof n.length && Ke.call(n, "callee") && !Me.call(n, "callee") || !1;
    });

    var st = Ye || function (n) {
      return n && "object" == _typeof(n) && "number" == typeof n.length && $e.call(n) == B || !1;
    },
        pt = hn({
      args: "object",
      init: "[]",
  ...
  var un = g();
  "function" == typeof define && "object" == _typeof(define.amd) && define.amd ? (nn._ = un, define(function () {
    return un;
