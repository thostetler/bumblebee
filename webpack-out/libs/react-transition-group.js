...
!function (e, t) {
  ...
  return function (e) {
    ...
    var u = n(0),
      ...
      function t(n, o) {
        ...
        var r = a(this, e.call(this, n, o)),
            ...
            u = void 0;
        return r.appearStatus = null, n.in ? l ? (u = m, r.appearStatus = v) : u = x : u = n.unmountOnExit || n.mountOnEnter ? y : m, r.state = {
          status: u
      ...
      return s(t, e), t.prototype.getChildContext = function () {
        ...
        if (e !== this.props) {
          ...
          this.props.in ? n !== v && n !== x && (t = v) : n !== v && n !== x || (t = g);
        }
    ...
    b.contextTypes = {
      ...
      onExiting: l,
      onExited: l
    }, b.UNMOUNTED = 0, b.EXITED = 1, b.ENTERING = 2, b.ENTERED = 3, b.EXITING = 4, t.default = (0, E.polyfill)(b);
  }, function (e, n) {
    e.exports = t;
  }, function (e, t, n) {
    "use strict";
    ...
    t.__esModule = !0, o.__suppressDeprecationWarning = !0, r.__suppressDeprecationWarning = !0, i.__suppressDeprecationWarning = !0, t.polyfill = a;
  }, function (e, t, n) {
    "use strict";
    ...
    var l = Object.assign || function (e) {
      ...
      return Object.keys(e).map(function (t) {
        ...
        y = (p.default.any, p.default.node, p.default.bool, p.default.bool, p.default.bool, p.default.func, {
      component: "div",
      ...
      return s(t, e), t.prototype.getChildContext = function () {
        ...
        var n = t.children,
            o = t.handleExited;
        return {
          children: t.firstRender ? (0, h.getInitialChildMapping)(e, o) : (0, h.getNextChildMapping)(e, n, o),
          firstRender: !1
        };
        ...
        return delete o.appear, delete o.enter, delete o.exit, null === t ? i : f.default.createElement(t, o, i);
      }, t;
    }(f.default.Component);

    m.childContextTypes = {
      transitionGroup: p.default.object.isRequired
    }, m.propTypes = {}, m.defaultProps = y, t.default = (0, d.polyfill)(m), e.exports = t.default;
  }, function (e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function (e) {
      ...
      function t() {
        ...
        return n = o = i(this, e.call.apply(e, [this].concat(l))), o.onEnter = function (e, t) {
          var n = o.getClassNames(t ? "appear" : "enter"),
              r = n.className;
          o.removeClasses(e, "exit"), x(e, r), o.props.onEnter && o.props.onEnter(e);
        }, o.onEntering = function (e, t) {
          var n = o.getClassNames(t ? "appear" : "enter"),
              r = n.activeClassName;
          o.reflowAndAddClass(e, r), o.props.onEntering && o.props.onEntering(e);
        }, o.onEntered = function (e, t) {
          var n = o.getClassNames("enter"),
              r = n.doneClassName;
          o.removeClasses(e, t ? "appear" : "enter"), x(e, r), o.props.onEntered && o.props.onEntered(e);
        }, o.onExit = function (e) {
          var t = o.getClassNames("exit"),
              n = t.className;
          o.removeClasses(e, "appear"), o.removeClasses(e, "enter"), x(e, n), o.props.onExit && o.props.onExit(e);
        }, o.onExiting = function (e) {
          var t = o.getClassNames("exit"),
              n = t.activeClassName;
          o.reflowAndAddClass(e, n), o.props.onExiting && o.props.onExiting(e);
        }, o.onExited = function (e) {
          var t = o.getClassNames("exit"),
              n = t.doneClassName;
          o.removeClasses(e, "exit"), x(e, n), o.props.onExited && o.props.onExited(e);
      ...
      return a(t, e), t.prototype.removeClasses = function (e, t) {
        var n = this.getClassNames(t),
            ...
            r = n.activeClassName,
            i = n.doneClassName;
        o && g(e, o), r && g(e, r), i && g(e, i);
      }, t.prototype.reflowAndAddClass = function (e, t) {
        t && (e && e.scrollTop, x(e, t));
      }, t.prototype.render = function () {
        var e = s({}, this.props);
        return delete e.classNames, E.default.createElement(m.default, s({}, e, {
    ...
    var l = n(0),
        ...
        d = n(6),
        h = o(d),
        E = (u.default.bool.isRequired, function (e) {
      function t() {
        var n, o, r;
        i(this, t);
        ...
        return n = o = a(this, e.call.apply(e, [this].concat(l))), y.call(o), r = n, a(o, r);
      }

      return s(t, e), t.prototype.handleLifecycle = function (e, t, n) {
        var o,
            r = this.props.children,
            i = c.default.Children.toArray(r)[t];
        i.props[e] && (o = i.props)[e].apply(o, n), this.props[e] && this.props[e]((0, f.findDOMNode)(this));
      }, t.prototype.render = function () {
        var e = this.props,
            t = e.children,
            n = e.in,
            o = r(e, ["children", "in"]),
            i = c.default.Children.toArray(t),
            a = i[0],
            s = i[1];
        return delete o.onEnter, delete o.onEntering, delete o.onEntered, delete o.onExit, delete o.onExiting, delete o.onExited, c.default.createElement(h.default, o, n ? c.default.cloneElement(a, {
          key: "first",
          onEnter: this.handleEnter,
          onEntering: this.handleEntering,
          onEntered: this.handleEntered
        }) : c.default.cloneElement(s, {
          key: "second",
    ...
    E.propTypes = {}, t.default = E, e.exports = t.default;
  }, function (e, t, n) {
    "use strict";
    ...
    function s(e, t, n) {
      ...
      return Object.keys(s).forEach(function (o) {
        ...
        if ((0, l.isValidElement)(r)) {
          ...
          !p || u && !f ? p || !u || f ? p && u && (0, l.isValidElement)(c) && (s[o] = (0, l.cloneElement)(r, {
            onExited: n.bind(null, r),
            in: c.props.in,
            exit: i(r, "exit", e),
            enter: i(r, "enter", e)
          })) : s[o] = (0, l.cloneElement)(r, {
            in: !1
          }) : s[o] = (0, l.cloneElement)(r, {
            onExited: n.bind(null, r),
            in: !0,
    ...
    t.__esModule = !0, t.getChildMapping = o, t.mergeChildMappings = r, t.getInitialChildMapping = a, t.getNextChildMapping = s;
    var l = n(1);
  }]);
});
