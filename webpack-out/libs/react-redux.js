...
!function (e, t) {
  ...
  var m,
    ...
    t.typeOf = S, t.AsyncMode = f, t.ConcurrentMode = p, t.ContextConsumer = s, t.ContextProvider = c, t.Element = n, t.ForwardRef = l, t.Fragment = u, t.Lazy = m, t.Memo = v, t.Portal = o, t.Profiler = i, t.StrictMode = a, t.Suspense = d, t.isValidElementType = function (e) {
      return "string" == typeof e || "function" == typeof e || e === u || e === p || e === i || e === a || e === d || e === y || "object" == _typeof(e) && null !== e && (e.$$typeof === m || e.$$typeof === v || e.$$typeof === c || e.$$typeof === s || e.$$typeof === l || e.$$typeof === b || e.$$typeof === h);
  ...
  function U(e, r) {
    ...
    var n = r.getDisplayName,
      ...
      return "ConnectAdvanced(" + e + ")";
        ...
        g = r.context,
        O = void 0 === g ? s : g,
        w = v(r, ["getDisplayName", "methodName", "renderCountProp", "shouldHandleStateChanges", "storeKey", "withRef", "forwardRef", "context"]),
        C = O;
    return function (r) {
      ...
      function m(n) {
        ...
        k(F, [$, R, N, s, U, j, w]), k(W, [l, h, O, P, $, R, N, j, w, T], [h, O, P]);
        var A = t.useMemo(function () {
          return o.createElement(r, y({}, U, {
            ref: i
          }));
        }, [i, r, U]);
        return t.useMemo(function () {
          return l ? o.createElement(f.Provider, {
            value: x
          }, A) : A;
        }, [f, A, x]);
      }
  ...
  var V = [function (e) {
    ...
    return e && "object" == _typeof(e) ? L(function (t) {
  ...
  var fe = se();
  f = n.unstable_batchedUpdates, Object.defineProperty(e, "batch", {
    enumerable: !0,
    get: function get() {
    ...
    return t.useEffect(function () {
      ...
      return e.trySubscribe(), i !== r.getState() && e.notifyNestedSubs(), function () {
        e.tryUnsubscribe(), e.onStateChange = null;
      };
    }, [a, i]), o.createElement((n || s).Provider, {
      value: a
    }, u);
  }, e.ReactReduxContext = s, e.connect = re, e.connectAdvanced = U, e.createDispatchHook = ae, e.createSelectorHook = se, e.createStoreHook = oe, e.shallowEqual = I, e.useDispatch = ie, e.useSelector = fe, e.useStore = ue, Object.defineProperty(e, "__esModule", {
    value: !0
  });
});
