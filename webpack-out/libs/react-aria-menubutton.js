...
!function (e, t) {
  ...
  return function (e) {
    ...
    e.exports = function (e, t, n) {
      for (var r in n = n || {}, t) {
        t.hasOwnProperty(r) && (n[r] || (e[r] = t[r]));
      }
    };
  }, function (e, t, n) {
    "use strict";
    ...
    e.exports = {
      refType: r.oneOfType([r.func, r.shape({
        current: r.elementType
      })])
    };
  }, function (e, t, n) {
    "use strict";

    var r = n(1).createContext();
    e.exports = r;
  }, function (e, t, n) {
    "use strict";

    var r = {},
        o = "a menu outside a mounted Wrapper with an id, or a menu that does not exist";
    e.exports = {
      registerManager: function registerManager(e, t) {
        r[e] = t;
      },
      unregisterManager: function unregisterManager(e) {
        delete r[e];
      },
      openMenu: function openMenu(e, t) {
        var n = r[e];
        if (!n) throw new Error("Cannot open " + o);
        n.openMenu(t);
      },
      closeMenu: function closeMenu(e, t) {
        var n = r[e];
        if (!n) throw new Error("Cannot close " + o);
        n.closeMenu(t);
      }
    };
  }, function (e, t, n) {
    ...
    var o = n(1),
      ...
      function t() {
        ...
        return n = i = r(this, e.call.apply(e, [this].concat(a))), i.ref = o.createRef(), i.handleKeyDown = function (e) {
          "Enter" !== e.key && " " !== e.key || "a" === i.props.tag && i.props.href || (e.preventDefault(), i.selectItem(e));
        }, i.selectItem = function (e) {
          var t = void 0 !== i.props.value ? i.props.value : i.props.children;
          i.props.ambManager.handleSelection(t, e);
        }, i.setRef = function (e) {
          i.ref.current = e, "function" == typeof i.props.forwardedRef ? i.props.forwardedRef(e) : i.props.forwardedRef && (i.props.forwardedRef.current = e);
        }, r(i, n);
      }
      ...
      return function (e, t) {
        ...
        return u(e, this.props, c), o.createElement(this.props.tag, e, this.props.children);
      }, t;
    }(o.Component);

    f.propTypes = c, f.defaultProps = {
      tag: "div"
    }, e.exports = o.forwardRef(function (e, t) {
      return o.createElement(s.Consumer, null, function (n) {
        var r = {
          ambManager: n,
          forwardedRef: t
        };
        return u(r, e, {
          ambManager: c.ambManager,
          children: c.children,
          forwardedRef: c.forwardedRef
        }), o.createElement(f, r, e.children);
      });
    });
  }, function (e, t) {
    e.exports = function (e, t, n) {
      ...
      function c(t) {
        a = !0, i || (i = !0, e.addEventListener("touchmove", f, n), e.addEventListener("touchend", p, n), e.addEventListener("touchcancel", l, n), s = !1, r = t.touches[0].clientX, o = t.touches[0].clientY);
      }

      function f(e) {
        s || Math.abs(e.touches[0].clientX - r) <= 10 && Math.abs(e.touches[0].clientY - o) <= 10 || (s = !0);
      }
      ...
      function d() {
        e.removeEventListener("touchmove", f, n), e.removeEventListener("touchend", p, n), e.removeEventListener("touchcancel", l, n);
      }

      return e.addEventListener("click", u, n), e.addEventListener("touchstart", c, n), {
        remove: function remove() {
          e.removeEventListener("click", u, n), e.removeEventListener("touchstart", c, n), d();
        }
      };
    };
  }, function (e, t, n) {
    ...
    var o = n(1),
        ...
        f = {
      ambManager: i.object.isRequired,
      children: i.oneOfType([i.func, i.node]).isRequired,
      forwardedRef: u,
      tag: i.string
    },
        p = function (e) {
      function t() {
        ...
        return n = i = r(this, e.call.apply(e, [this].concat(u))), i.ref = o.createRef(), i.addTapListener = function () {
          var e = i.ref.current;

          if (e) {
            var t = e.ownerDocument;
            t && (i.tapListener = s(t.documentElement, i.handleTap));
          }
        }, i.handleTap = function (e) {
          i.ref.current.contains(e.target) || i.props.ambManager.button.ref.current.contains(e.target) || i.props.ambManager.closeMenu();
        }, i.setRef = function (e) {
          i.ref.current = e, "function" == typeof i.props.forwardedRef ? i.props.forwardedRef(e) : i.props.forwardedRef && (i.props.forwardedRef.current = e);
        }, r(i, n);
      }
      ...
      return function (e, t) {
        ...
        return t.options.closeOnBlur && (r.onBlur = t.handleBlur), c(r, e, f), c(r, {
          ref: this.setRef
        }), o.createElement(e.tag, r, n);
      }, t;
    }(o.Component);
    ...
    p.propTypes = f, p.defaultProps = {
      ...
      return o.createElement(a.Consumer, null, function (n) {
        ...
        }), o.createElement(p, r, e.children);
      });
    });
  }, function (e, t, n) {
    "use strict";
    ...
    var o = n(1),
      ...
      function t() {
        ...
        return n = i = r(this, e.call.apply(e, [this].concat(a))), i.ref = o.createRef(), i.handleKeyDown = function (e) {
          ...
          i.props.disabled || i.props.ambManager.toggleMenu({}, {
            focusMenu: !1
          });
        }, i.setRef = function (e) {
          i.ref.current = e, "function" == typeof i.props.forwardedRef ? i.props.forwardedRef(e) : i.props.forwardedRef && (i.props.forwardedRef.current = e);
      ...
      return function (e, t) {
        ...
        var e = this.props,
          ...
          onClick: this.handleClick
            ...
            r = {};
        return u(r, c), ["button", "fieldset", "input", "optgroup", "option", "select", "textarea"].indexOf(e.tag) >= 0 && delete r.disabled, t.options.closeOnBlur && (n.onBlur = t.handleBlur), u(n, e, r), u(n, {
          ref: this.setRef
        }), o.createElement(e.tag, n, e.children);
      }, t;
    }(o.Component);
    ...
    function n(e) {
      ...
      }, this._keybindingsLookup = [], this._settings.keybindings) {
        (n = this._settings.keybindings[t]) && [].concat(n).forEach(function (e) {
    ...
    n.prototype.activate = function () {
      ...
      return null !== t && void 0 !== t ? this._members.splice(t, 0, o) : this._members.push(o), this;
    ...
    var r = n(10),
      ...
      init: function init(e) {
        this.updateOptions(e), this.handleBlur = function () {
          var e = this;
        ...
        }.bind(this), this.focusGroup = r(i), this.button = null, this.menu = null, this.isOpen = !1;
      },
      updateOptions: function updateOptions(e) {
        var t = this.options;
        this.options = e || this.options || {}, void 0 === this.options.closeOnSelection && (this.options.closeOnSelection = !0), void 0 === this.options.closeOnBlur && (this.options.closeOnBlur = !0), this.options.id && o.registerManager(this.options.id, this), t && t.id && t.id !== this.options.id && o.unregisterManager(this.options.id, this);
      },
      ...
      handleButtonNonArrowKey: function handleButtonNonArrowKey(e) {
      ...
      toggleMenu: function toggleMenu(e, t) {
    ...
    var r = n(1),
      ...
      }(t, e), t.prototype.componentDidUpdate = function () {
        this.manager.updateOptions(f(this.props));
      }, t.prototype.render = function () {
        var e = {};
        return u(e, this.props, c), r.createElement(s.Provider, {
          value: this.manager
    ...
    p.propTypes = c, p.defaultProps = {
      ...
      return u(n, e, {
        ...
        forwardedRef: t
      }), r.createElement(p, n, e.children);
    });
  }, function (e, t, n) {
    "use strict";
