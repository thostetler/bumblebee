...
(function () {
  ...
  require.register("runnable.js", function (module, exports, require) {
    ...
    Runnable.prototype.run = function (fn) {
      var self = this,
          ...
          ctx = this.ctx,
          finished,
          emitted; // Some times the ctx exists but it is not runnable
  ...
  require.register("runner.js", function (module, exports, require) {
    ...
    Runner.prototype.globalProps = function () {
      var props = utils.keys(global); // non-enumerables
    ...
    Runner.prototype.runTests = function (suite, fn) {
      ...
      function next(err, errSuite) {
        ...
        if (err) return hookErr(err, errSuite, true); // next test
    ...
    Runner.prototype.uncaught = function (err) {
      ...
      if (wasAlreadyDone) return; // recover from test
    ...
    function extraGlobals() {
      if (_typeof(process) === 'object' && typeof process.version === 'string') {
