define([
  ...
  describe('Library Widget (library_individual.spec.js)', function() {
    ...
    var stubData1 = {
      ...
      solr: {
          ...
          docs: [
            {
              ...
              pubdate: '2015-01-00',
              title: ['The NASA Astrophysics Data System joins the Revolution'],
            },
            {
              '[citations]': {
                num_citations: 5,
              ...
              aff: ['Smithsonian Astrophysical Observatory'],
        ...
        responseHeader: {
          ...
          params: {
            fl:
              'title,abstract,bibcode,author,aff,links_data,property,[citations],pub,pubdate',
            fq: '{!bitset}',
            q: '*:*',
            rows: '1000',
            wt: 'json',
        ...
        response: {
          docs: [
            ...
            },
            {
              ...
              pub: 'ArXiv e-prints',
              pubdate: '2015-05-00',
              title: ['Pathway to a Compact SASE FEL Device'],
            },
          ],
          numFound: 3,
          start: 0,
    ...
    it('should revert to original if a blank value is given for description/title', function() {
      ...
      expect($('textarea', descFormSelector, $test).val()).to.eql(
        originalDescription
      );
    ...
    it("should display different header views depending on a person's permissions, allowing admin/owners to edit title/description ", function() {
      ...
      $('#test .editable-item form')
        .eq(0)
        .find('input')
        .val('here is a better, newer title');

      expect(fakeLibraryController.updateLibraryMetadata.args[0]).to.eql(
        undefined
      );
      ...
      expect(fakeLibraryController.updateLibraryMetadata.args[0][0]).to.eql(
        '1'
      );
      expect(fakeLibraryController.updateLibraryMetadata.args[0][1]).to.eql({
        name: 'here is a better, newer title',
      });
    ...
    it('should allow users to navigate to other subviews (export, metrics, library, vis, admin)', function() {
      ...
      expect(
        $('li.tab.active')
          ...
          .eq(0)
          .data('tab')
      ).to.eql('visualization-AuthorNetwork');
    ...
    it('should display the correct metadata', function() {
      ...
      try {
        expect(
          $('.s-library-info .col-sm-3')
            .eq(1)
            .find('span')
            .text()
        ).to.eql('Apr 3 2015, 12:30am');
      } catch (e) {
        expect(
          $('.s-library-info .col-sm-3')
            .eq(1)
