define([], function () {
  ...
  require(['async-load!backbone-validation'], function (prom) {
  ...
  require(['async-load!d3', 'async-load!d3-cloud'], function(d3Prom, cloudProm) {
    
    var cb = function (d3, cloud) {
    ...
    Promise.all([d3Prom, cloudProm]).then((values) => {
