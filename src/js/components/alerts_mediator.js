...
var AlertsMediator = GenericModule.extend({
  ...
  activate: function(beehive, app) {
    ...
    this.getWidget().fail(function() {
      console.error(
        'If you want to use AlertController, you also need to have a Widget capable of displaying the messages (default: AlertsWidget)'
      );
  ...
  getWidget: function() {
    ...
    if (this._widget) {
      ...
      this.getApp()
        ._getWidget(this.widgetName || 'AlertsWidget')
