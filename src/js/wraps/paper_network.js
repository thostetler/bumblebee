...
import ContainerTemplate from 'js/wraps/templates/paper-network-container.html';
import GroupDataTemplate from 'js/wraps/templates/paper-network-data.html';
import LinkDataTemplate from 'js/wraps/templates/paper-network-link-data.html';
  ...
  renderGraph: function() {
    ...
    var ticks = svg
      ...
      .attr('transform', function(d) {
        return (
          'rotate(' + ((d.angle * 180) / Math.PI - 90) + ')' + 'translate(' + (that.config.outerRadius * 1) / 1 + ',0)'
        );
      });
    ...
    text.on('mouseover', fadeText('mouseenter')).on('mouseout', fadeText('mouseleave'));
