    ...
    return (
      <div>
        <div className="list-group">
          ...
          <a href="javascript:void(0);" className="list-group-item" onClick={() => this.props.goTo(page.AUTHORS_FORM)}>
            <h2 className="h4">Authors</h2>
            <p>Weekly updates on the latest papers by your favorite authors</p>
          </a>
          <a href="javascript:void(0);" className="list-group-item" onClick={() => this.props.goTo(page.KEYWORD_FORM)}>
          ...
          <a href="javascript:void(0);" className="list-group-item" onClick={() => this.props.goTo(page.GENERAL_FORM)}>
