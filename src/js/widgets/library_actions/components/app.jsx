...
const descriptions = {
  ...
  intersection:
    'Take the intersection of the source and the secondary libraries. This finds any records contained in all of the input libraries. The result is saved to a new library',
  difference:
    'Take the difference between the source and the secondary libraries. This finds all records contained in the source library but in none of the secondary libraries. The result is saved to a new library',
  copy:
    'Copy the contents of the source library into the target library. The target library is not emptied first; use the empty operation on the target library first in order to create a duplicate of the source library in the target library',
  ...
  <div className="form-group">
    <div className="well clearfix" style={{ borderRadius: '4px' }}>
      <div className="col-sm-1">
        <i className="fa fa-question-circle fa-2x" aria-hidden="true" />
      </div>
      <div className="col-sm-11">{descriptions[item]}</div>
    </div>
  </div>
);
