...
define([
  ...
  var ListOfThingsWidget = BaseWidget.extend({
    ...
    processResponse: function (apiResponse) {
      ...
      if ((this.model.get("perPage") === this.collection.length) || 
        (this.model.has('pageData') && this.model.get('pageData').nextPossible === false)
      ) {
    ...
    * */
    ...
    updatePagination: function (options) {
      ...
      if (_.isNumber(opts.page)) {
        ...
        if (_.isEmpty(this.collection) && _.isNumber(start) && _.isNumber(opts.perPage)) {
