...
define([
  ...
  'js/widgets/filter_visualizer/templates/widget-view',
  'js/widgets/filter_visualizer/templates/item-view',
        ...
        function(k) {
          if (k.indexOf('fq_') == 0) {
            ...
            if (filteredKeys.length == 1) {
              ...
              console.warn(
                'no fq metadata available, so presumably query is being loaded from url (if not, there is a problem!) '
              );
            }
