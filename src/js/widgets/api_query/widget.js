...
import ItemTemplate from 'js/widgets/api_query/templates/item-view.html';
import WidgetTemplate from 'js/widgets/api_query/templates/widget-view.html';
import $ from 'jquery';
...
var WidgetController = Marionette.Controller.extend({
  initialize: function(apiQuery) {
    ...
    this.view = new WidgetView({
      ...
      model: new KeyValue({ initialValue: apiQuery.url() || 'q=planet' }),
    });
