define(function (require) {
  ...
  return {
    ...
    widgets: {
      ...
      ExportWidget: require('es6!js/widgets/export/widget.jsx.js'),
      Sort: require('js/widgets/sort/widget'),
      ...
      AuthorAffiliationTool: require('es6!js/widgets/author_affiliation_tool/widget.jsx.js'),
      ...
      ShowResources: require('es6!js/widgets/resources/widget.jsx.js'),
