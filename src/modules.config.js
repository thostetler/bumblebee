define(function (require) {
  ...
  return {
    ...
    widgets: {
      ...
      ExportWidget: require('es6!js/widgets/export/widget.jsx'),
      ...
      AuthorAffiliationTool: require('es6!js/widgets/author_affiliation_tool/widget.jsx'),
      ...
      ShowResources: require('es6!js/widgets/resources/widget.jsx'),
