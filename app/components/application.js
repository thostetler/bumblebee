    ...
    _loadModules: function (sectionName, modulePrescription, ignoreErrors) {
      ...
      _.forEach(implNames, function (name) {
        switch(name) {
          ...
          case 'ExportWidget': require(['widgets/export/widget.jsx'], _.partial(callback, 'ExportWidget'), _.partial(errback, 'ExportWidget')); break;
          case 'Sort': require(['widgets/sort/widget.jsx'], _.partial(callback, 'Sort'), _.partial(errback, 'Sort')); break;
          ...
          case 'AuthorAffiliationTool': require(['widgets/author_affiliation_tool/widget.jsx'], _.partial(callback, 'AuthorAffiliationTool'), _.partial(errback, 'AuthorAffiliationTool')); break;
          ...
          case 'OrcidSelector': require(['widgets/orcid-selector/widget.jsx'], _.partial(callback, 'OrcidSelector'), _.partial(errback, 'OrcidSelector')); break;
          ...
          case 'ShowResources': require(['widgets/resources/widget.jsx'], _.partial(callback, 'ShowResources'), _.partial(errback, 'ShowResources')); break;
          case 'ShowAssociated': require(['widgets/associated/widget.jsx'], _.partial(callback, 'ShowAssociated'), _.partial(errback, 'ShowAssociated')); break;
